# 项目三 Linux文件系统与磁盘管理 {#项目三-linux文件系统与磁盘管理 .unnumbered}
...
#### 3.1.4 改变文件权限 {#改变文件权限 .unnumbered}
...
在终端使用vi工具编辑/etc/fstab文件。在终端中输入命令"vi
...
#### 3.4.1 逻辑卷管理器概述 {#逻辑卷管理器概述 .unnumbered}
...
（6）将RAID设备/dev/md0挂载到指定的目录/mnt/md0中。
